        ...
        {requests?.map((r: any) => (
          <Card key={r.id}>
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-sm text-slate-500 mt-1 flex items-center gap-1">
                    <User className="h-3 w-3" /> {r.student?.firstName} {r.student?.lastName}
            ...
            <CardContent className="space-y-3">
              <div>
                <p className="text-xs text-slate-400 uppercase font-medium">Технологии</p>
                <p className="text-sm text-slate-700">{r.technologies}</p>
              </div>
              <div>
                <p className="text-xs text-slate-400 uppercase font-medium">Описание</p>
